...
- [ ] **ARCH-11**: Pré-geração e crop automático de capa OpenGraph no momento do upload/cadastro do imóvel — processar e salvar uma versão otimizada 1200x630 (16:9) para garantir que o preview no WhatsApp/Telegram venha sempre padronizado, independentemente da proporção da foto original.
