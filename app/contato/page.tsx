                ...
                <div className="container" style={{ maxWidth: '1000px' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ backgroundColor: '#1f2937', color: 'white', padding: '2rem', borderRadius: '1rem', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            <h3 style={{ fontSize: '1.5rem', marginBottom: '1rem', color: 'white' }}>HV5</h3>
                            ...
                            <div style={{ marginBottom: '2rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                                ...
                                <a href="tel:81986661683" style={{ fontSize: '1.1rem', fontWeight: 500, color: 'white', textDecoration: 'none' }}>(81) 98666-1683</a>
                                <a href="tel:81999529391" style={{ fontSize: '1.1rem', fontWeight: 500, color: 'white', textDecoration: 'none' }}>(81) 99952-9391</a>
                            </div>
