...
const BASE_SELECT = `
  SELECT 
    ...
    COALESCE(emp_carac.parque_aquatico::int, emp_carac_self.parque_aquatico::int, carac.parque_aquatico::int, 0) AS parque_aquatico,
    COALESCE(emp_carac.salao_festas::int, emp_carac_self.salao_festas::int, carac.salao_festas::int, 0) AS salao_festas,
    COALESCE(emp_carac.espaco_gourmet::int, emp_carac_self.espaco_gourmet::int, carac.espaco_gourmet::int, 0) AS espaco_gourmet,
    COALESCE(emp_carac.espaco_zen::int, emp_carac_self.espaco_zen::int, carac.espaco_zen::int, 0) AS espaco_zen,
    COALESCE(emp_carac.coworking::int, emp_carac_self.coworking::int, carac.coworking::int, 0) AS coworking,
    COALESCE(emp_carac.piquenique::int, emp_carac_self.piquenique::int, carac.piquenique::int, 0) AS piquenique,
    COALESCE(emp_carac.espaco_grill::int, emp_carac_self.espaco_grill::int, carac.espaco_grill::int, 0) AS espaco_grill,
    COALESCE(emp_carac.pet_park::int, emp_carac_self.pet_park::int, carac.pet_park::int, 0) AS pet_park,
    COALESCE(emp_carac.supermarket::int, emp_carac_self.supermarket::int, carac.supermarket::int, 0) AS supermarket,
    COALESCE(emp_carac.espaco_gamer::int, emp_carac_self.espaco_gamer::int, carac.espaco_gamer::int, 0) AS espaco_gamer,
    COALESCE(emp_carac.salao_jogos::int, emp_carac_self.salao_jogos::int, carac.salao_jogos::int, 0) AS salao_jogos,
    COALESCE(emp_carac.sala_cinema::int, emp_carac_self.sala_cinema::int, carac.sala_cinema::int, 0) AS sala_cinema,
    COALESCE(emp_carac.playground::int, emp_carac_self.playground::int, carac.playground::int, 0) AS playground,
    COALESCE(emp_carac.sala_yoga::int, emp_carac_self.sala_yoga::int, carac.sala_yoga::int, 0) AS sala_yoga,
    COALESCE(emp_carac.redario::int, emp_carac_self.redario::int, carac.redario::int, 0) AS redario,
    COALESCE(emp_carac.horta::int, emp_carac_self.horta::int, carac.horta::int, 0) AS horta,
    COALESCE(emp_carac.area_convivencia::int, emp_carac_self.area_convivencia::int, carac.area_convivencia::int, 0) AS area_convivencia,
    COALESCE(carac.espacos_gourmet_multiplos::int, 0) AS espacos_gourmet_multiplos,
    COALESCE(emp_carac.academia::int, emp_carac_self.academia::int, carac.academia::int, 0) AS academia,
    COALESCE(emp_carac.sala_funcional::int, emp_carac_self.sala_funcional::int, carac.sala_funcional::int, 0) AS sala_funcional,
    COALESCE(emp_carac.quadra_poliesportiva::int, emp_carac_self.quadra_poliesportiva::int, carac.quadra_poliesportiva::int, 0) AS quadra_poliesportiva,
    COALESCE(emp_carac.quadra_beach_tennis::int, emp_carac_self.quadra_beach_tennis::int, carac.quadra_beach_tennis::int, 0) AS quadra_beach_tennis,
    COALESCE(emp_carac.campo_futebol_society::int, emp_carac_self.campo_futebol_society::int, carac.campo_futebol_society::int, 0) AS campo_futebol_society,
    COALESCE(emp_carac.quadra_volei_praia::int, emp_carac_self.quadra_volei_praia::int, carac.quadra_volei_praia::int, 0) AS quadra_volei_praia,
    COALESCE(emp_carac.quadra_tenis::int, emp_carac_self.quadra_tenis::int, carac.quadra_tenis::int, 0) AS quadra_tenis,
    COALESCE(emp_carac.ciclovia::int, emp_carac_self.ciclovia::int, carac.ciclovia::int, 0) AS ciclovia,
    COALESCE(emp_carac.pista_cooper::int, emp_carac_self.pista_cooper::int, carac.pista_cooper::int, 0) AS pista_cooper,
    COALESCE(emp_carac.controle_acesso_automatizado::int, emp_carac_self.controle_acesso_automatizado::int, carac.controle_acesso_automatizado::int, 0) AS controle_acesso_automatizado,
    COALESCE(emp_carac.sala_encomendas_delivery::int, emp_carac_self.sala_encomendas_delivery::int, carac.sala_encomendas_delivery::int, 0) AS sala_encomendas_delivery,
    COALESCE(emp_carac.wi_fi_areas_comuns::int, emp_carac_self.wi_fi_areas_comuns::int, carac.wi_fi_areas_comuns::int, 0) AS wi_fi_areas_comuns,
    COALESCE(
