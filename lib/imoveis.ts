...
const BASE_SELECT = `
  SELECT 
    ...
    COALESCE(carac.parque_aquatico::int, emp_carac.parque_aquatico::int, emp_carac_self.parque_aquatico::int) AS parque_aquatico,
    COALESCE(carac.salao_festas::int, emp_carac.salao_festas::int, emp_carac_self.salao_festas::int) AS salao_festas,
    COALESCE(carac.espaco_gourmet::int, emp_carac.espaco_gourmet::int, emp_carac_self.espaco_gourmet::int) AS espaco_gourmet,
    COALESCE(carac.espaco_zen::int, emp_carac.espaco_zen::int, emp_carac_self.espaco_zen::int) AS espaco_zen,
    COALESCE(carac.coworking::int, emp_carac.coworking::int, emp_carac_self.coworking::int) AS coworking,
    COALESCE(carac.piquenique::int, emp_carac.piquenique::int, emp_carac_self.piquenique::int) AS piquenique,
    COALESCE(carac.espaco_grill::int, emp_carac.espaco_grill::int, emp_carac_self.espaco_grill::int) AS espaco_grill,
    COALESCE(carac.pet_park::int, emp_carac.pet_park::int, emp_carac_self.pet_park::int) AS pet_park,
    COALESCE(carac.supermarket::int, emp_carac.supermarket::int, emp_carac_self.supermarket::int) AS supermarket,
    COALESCE(carac.espaco_gamer::int, emp_carac.espaco_gamer::int, emp_carac_self.espaco_gamer::int) AS espaco_gamer,
    COALESCE(carac.salao_jogos::int, emp_carac.salao_jogos::int, emp_carac_self.salao_jogos::int) AS salao_jogos,
    COALESCE(carac.sala_cinema::int, emp_carac.sala_cinema::int, emp_carac_self.sala_cinema::int) AS sala_cinema,
    COALESCE(carac.playground::int, emp_carac.playground::int, emp_carac_self.playground::int) AS playground,
    COALESCE(carac.sala_yoga::int, emp_carac.sala_yoga::int, emp_carac_self.sala_yoga::int) AS sala_yoga,
    COALESCE(carac.redario::int, emp_carac.redario::int, emp_carac_self.redario::int) AS redario,
    COALESCE(carac.horta::int, emp_carac.horta::int, emp_carac_self.horta::int) AS horta,
    COALESCE(carac.area_convivencia::int, emp_carac.area_convivencia::int, emp_carac_self.area_convivencia::int) AS area_convivencia,
    COALESCE(carac.espacos_gourmet_multiplos::int, 0) AS espacos_gourmet_multiplos,
    COALESCE(carac.academia::int, emp_carac.academia::int, emp_carac_self.academia::int) AS academia,
    COALESCE(carac.sala_funcional::int, emp_carac.sala_funcional::int, emp_carac_self.sala_funcional::int) AS sala_funcional,
    COALESCE(carac.quadra_poliesportiva::int, emp_carac.quadra_poliesportiva::int, emp_carac_self.quadra_poliesportiva::int) AS quadra_poliesportiva,
    COALESCE(carac.quadra_beach_tennis::int, emp_carac.quadra_beach_tennis::int, emp_carac_self.quadra_beach_tennis::int) AS quadra_beach_tennis,
    COALESCE(carac.campo_futebol_society::int, emp_carac.campo_futebol_society::int, emp_carac_self.campo_futebol_society::int) AS campo_futebol_society,
    COALESCE(carac.quadra_volei_praia::int, emp_carac.quadra_volei_praia::int, emp_carac_self.quadra_volei_praia::int) AS quadra_volei_praia,
    COALESCE(carac.quadra_tenis::int, emp_carac.quadra_tenis::int, emp_carac_self.quadra_tenis::int) AS quadra_tenis,
    COALESCE(carac.ciclovia::int, emp_carac.ciclovia::int, emp_carac_self.ciclovia::int) AS ciclovia,
    COALESCE(carac.pista_cooper::int, emp_carac.pista_cooper::int, emp_carac_self.pista_cooper::int) AS pista_cooper,
    COALESCE(carac.controle_acesso_automatizado::int, emp_carac.controle_acesso_automatizado::int, emp_carac_self.controle_acesso_automatizado::int) AS controle_acesso_automatizado,
    COALESCE(carac.sala_encomendas_delivery::int, emp_carac.sala_encomendas_delivery::int, emp_carac_self.sala_encomendas_delivery::int) AS sala_encomendas_delivery,
    COALESCE(carac.wi_fi_areas_comuns::int, emp_carac.wi_fi_areas_comuns::int, emp_carac_self.wi_fi_areas_comuns::int) AS wi_fi_areas_comuns,
    COALESCE(
